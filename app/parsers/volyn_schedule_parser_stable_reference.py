...
# Stable reference snapshot of the working Volyn parser.
# Purpose:
# - Keep an immutable baseline for future retuning/refactoring comparisons.
# - Not used by runtime wiring unless explicitly imported/swapped.
